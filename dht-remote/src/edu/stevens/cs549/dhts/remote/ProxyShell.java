...
public class ProxyShell extends ShellBase {
	...
	protected ProxyShell(IShell base, RemoteEndpoint.Basic sender) {
	...
	private void quitShell() throws IOException, EncodeException {
		terminated = true;
		System.out.println("I send quit");
		sender.sendText("quit ");
